function [fig1,fig2] = compareTriggerStreams(t,amp,dac,varargin)
%% COMPARETRIGGERSTREAMS   Plot subplot comparisons of trigger ADC & DAC 
%
%  fig1 = COMPARETRIGGERSTREAMS(amp,dac,'NAME',value,...);
%  [fig1,fig2] = COMPARETRIGGERSTREAMS(amp,dac,'NAME',value,...);
%
%  --------
%   INPUTS
%  --------
