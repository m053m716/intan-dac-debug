...
HPF_coefficient = fi(2*filterCoefficient,0,18,0,...
...
for i = 1:N
   ...
   if logical(positive_overflow)
      warning('Positive overflow (sample %d).',i);
      multiplier_in = fi(131071,0,18,0,...
         'MaxProductWordLength',36,...
         'ProductWordLength',36,...
         'MaxSumWordLength',32,...
         'SumMode','KeepMSB',...
         'ProductMode','KeepMSB'); % 2^17-1
   else
      if logical(negative_overflow)
         warning('Negative overflow (samples %d).',i);
         multiplier_in = fi(131072,0,18,0,...
            'MaxProductWordLength',36,...
            'ProductWordLength',36,...
            'MaxSumWordLength',32,...
            'SumMode','KeepMSB',...
         ...
         multiplier_in = fi(multiplier_in_before_limit,0,18,0,...
            'ProductWordLength',36,...
            'MaxProductWordLength',36,...
            'MaxSumWordLength',32,...
            'SumMode','KeepMSB',...
   ...
   HPF_new_state = HPF_state + ...
      fi(bitsliceget(multiplier_out,35,4),0,32,0,...
         'MaxProductWordLength',36,...
         'ProductWordLength',36,...
         'MaxSumWordLength',32,...
         'SumMode','KeepMSB',...
         'ProductMode','KeepMSB');
   HPF_output = fi(bitsliceget(multiplier_in,18,3),1,16,0,...
         'MaxProductWordLength',36,...
         'ProductWordLength',36,...
         'MaxSumWordLength',32,...
         'SumMode','KeepMSB',...
         'ProductMode','KeepMSB'); % mult_in [17:2]
...
%% SUB-FUNCTIONS TO STAY ORGANIZED
   ...
   function z = twosCompSubtract(x,y)
      xb = fi(x+1,1,18,0,'MaxProductWordLength',36,...
         'ProductWordLength',36,...
         'MaxSumWordLength',32,...
         'SumMode','KeepMSB',...
         'ProductMode','KeepMSB');
